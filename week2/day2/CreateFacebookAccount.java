...
public class CreateFacebookAccount {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.name("firstname")).sendKeys("Chakra");

		// Step 8: Enter the last name
		driver.findElement(By.name("lastname")).sendKeys("G");

		// Step 9: Enter the mobile number
		driver.findElement(By.name("reg_email__")).sendKeys("987654");

		// Step 10: Enterthe password
		driver.findElement(By.id("password_step_input")).sendKeys("987654");
